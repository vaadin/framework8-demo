...
Compiling the app for production
-------------------
```
...
You should now have a Jetty server running on localhost:8888. Navigate to http://localhost:8888 to play with the application
...
You should now have a Jetty server running on localhost:8080. Navigate to [http://localhost:8888/](http://localhost:8888/) to play with the application
