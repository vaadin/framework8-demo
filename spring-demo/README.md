...
- spring-demo-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- spring-demo-ui: main application module, development time
- spring-demo-production: module that produces a production mode WAR for deployment
